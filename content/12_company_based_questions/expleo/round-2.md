...
### 3. Agile methodologies
Agile is an iterative approach to software development emphasizing flexibility, continuous delivery of value, and customer collaboration. It works in short cycles called sprints, promoting adaptability over rigid planning.
...
2.  **Partial Matches:** Use XPath `contains()` or `starts-with()`.
...
### 16. In your project where you had applied the OOP's Concept in java
-   **Encapsulation:** Page Object Model (`private` locators, `public` interaction methods).
